...
exports.properties = {
    add_disks: {
        ...
        payload: {
            ...
            type: 'string',
            valueValidator: 'utils.validBhyveSectSize'
        },
        updatable: true,
        zonexml: 'zone.device.net-attr.guest-block-size'
    }, 'disks.*.image_name': {
        deprecated: true,
        ignore: true,
        payload: {
        ...
        updatable: true,
        zonexml: 'zone.device.net-attr.notrim'
    }, 'disks.*.path': {
        payload: {
            allowed: {
                'bhyve': ['add', 'update'],
        ...
        updatable: true,
        zonexml: 'zone.device.net-attr.pptdev'
    }, 'pci_devices.*.rom': {
        payload: {
            allowed: {
                'bhyve': ['add', 'update']
        ...
        updatable: true,
        zonexml: 'zone.device.net-attr.rom'
    }, 'pci_devices.*.rom_exec': {
        loadValueTranslator: 'utils.fixBoolean',
        payload: {
            allowed: {
                'bhyve': ['add', 'update']
        ...
        updatable: true,
        zonexml: 'zone.device.net-attr.rom-exec'
    }, 'pci_devices.*.msi': {
        loadValueTranslator: 'utils.fixBoolean',
        payload: {
            allowed: {
        ...
        updatable: true,
        zonexml: 'zone.device.net-attr.msi'
    }, pid: {
        loadValueTranslator: 'utils.numberify',
        zoneinfo: 'init_pid'
    }, platform_buildstamp: {
...
exports.brand_options = {
    'bhyve': {
        'features': {
            ...
            'zlogin_console': true,
            'reprovision': true,
            'brand_install_script': '/usr/lib/brand/bhyve/binstall',
            'type': 'BHYVE',
            'var_svc_provisioning': true,
            'wait_for_hwsetup': false,
            'disk_models': ['virtio', 'ahci', 'nvme']
        }
    }, 'builder': {
        'features': {
