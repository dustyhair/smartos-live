...
- OS-7601 want channel support for imgadm.
  This change adds channel support for 'imgapi' sources and drops support for
  the (previously deprecated) 'dsapi' source.
  ...
  Otherwise, channels can be specified as a component of any URL parameter, e.g.
      ...
      imgadm source -a 'https://updates.joyent.com?channel=experimental'
      or
